            ...
            <section className={style.story__article}>
                <Container>
                    ...
                    <div className={style.story__articleFlex}>
                        ...
                        <img className={style.story__articleImg} src={template} alt="" />

                    </div>

                    <p className={style.story__articleDescribtion}>Карпати – це ідеальне місце для тих, хто тільки починає відкривати для себе світ гірських мандрівок. Тут можна знайти безліч маршрутів, які не потребують спеціальної підготовки чи складного спорядження, але водночас дарують неймовірні враження від природи. Легкі стежки пролягають через зелені пагорби, мальовничі полонини та соснові ліси, де кожен крок наповнює подорож спокоєм і свіжим повітрям. <br /> <br />
                        ...
                        Легкі маршрути – чудовий спосіб розпочати знайомство з горами, відчути ритм природи та зрозуміти, що мандрівка може бути доступною кожному. Карпати надихають і водночас навчають бережно ставитися до довкілля, адже краса цих місць заслуговує на те, щоб залишатися незмінною для наступних поколінь. <br /></p>
                    ...
                    <ul className={style.story__recommendedList}>
                        {/* <li className={style.story__recommended-item}>
                            ...
                            <div className={style.story__recommended-item-text-half}>
                                ...
                                <h3 className={style.story__recommended-half-name}>Національний парк «Сколівські Бескиди»: стежками природи</h3>
                                <button className={style.story__recommended-half-article-btn}>Переглянути статтю</button>
                                <button className={style.story__recommended-half-save}>
                                    <svg className={style.story__recommended-half-save-svg} xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
